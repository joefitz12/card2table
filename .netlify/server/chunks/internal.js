...
const options = {
	...
	templates: {
		app: ({ head, body, assets: assets2, nonce, env }) =>
			'<!DOCTYPE html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8" />\n	<meta name="viewport"\n		content="width=device-width, initial-scale=1, minimum-scale=1.0, maximum-scale=3.0, minimal-ui" />\n	<meta property="og:description" content="design board game card templates and upload CSV data to create printer-friendly card sheets" />\n	<link rel="icon" href="' +
			assets2 +
