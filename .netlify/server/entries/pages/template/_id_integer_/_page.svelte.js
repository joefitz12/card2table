...
import { t as template, g as activeElement, h as textElements, i as activeSidebarMenu, c as cardTemplate, a as cardTemplates, j as activeView } from "../../../../chunks/store.js";
...
const CardControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$template ? `<div class="flex column"><div class="flex column"><div class="flex row header" data-svelte-h="svelte-mtmd0k"><h3>Dimensions</h3></div> <div class="flex column container"><div class="flex row"><div class="flex column"><label for="card-template-width" data-svelte-h="svelte-16owgvg">Width</label> <input type="number" id="card-template-width" step="0.01" min="0"${add_attribute("value", $template.width, 0)}></div> <div class="flex column"><label for="card-template-height" data-svelte-h="svelte-eldnic">Height</label> <input type="number" id="card-template-height" step="0.01" min="0"${add_attribute("value", $template.height, 0)}></div> <div class="flex row"><div class="flex column"><label for="card-template-unit" data-svelte-h="svelte-cxavw">Unit</label> <select id="card-template-unit"><option selected value="in" data-svelte-h="svelte-1h4qxg6">in</option><option value="cm" data-svelte-h="svelte-gmh55k">cm</option></select></div></div></div> <fieldset class="flex column container padding"><legend data-svelte-h="svelte-1qp1cxt">Padding</legend> <div class="flex row"><div class="flex column"><label${add_attribute("for", `card-template-padding-top`, 0)} data-svelte-h="svelte-167tatq">Top</label> <input type="number"${add_attribute("id", `card-template-padding-top`, 0)} step="0.01" min="0"${add_attribute("value", $template.padding.top, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-padding-right`, 0)} data-svelte-h="svelte-18kwima">Right</label> <input type="number"${add_attribute("id", `card-template-padding-right`, 0)} step="0.01" min="0"${add_attribute("value", $template.padding.right, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-padding-bottom`, 0)} data-svelte-h="svelte-nolgsa">Bottom</label> <input type="number"${add_attribute("id", `card-template-padding-bottom`, 0)} step="0.01" min="0"${add_attribute("value", $template.padding.bottom, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-padding-left`, 0)} data-svelte-h="svelte-9ovb76">Left</label> <input type="number"${add_attribute("id", `card-template-padding-left`, 0)} step="0.01" min="0"${add_attribute("value", $template.padding.left, 0)}></div></div></fieldset></div></div> <div class="flex column"><div class="flex row header"><input type="color"${add_attribute("id", `border-color`, 0)}${add_attribute("value", $template.border.color, 0)}> <h3 data-svelte-h="svelte-13jgrfy">Border</h3></div> <fieldset class="flex column container"><legend data-svelte-h="svelte-uc2uzi">Width</legend> <div class="flex row"><div class="flex column"><label${add_attribute("for", `card-template-border-width-top`, 0)} data-svelte-h="svelte-be8b1q">Top</label> <input type="number"${add_attribute("id", `card-template-border-width-top`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.width.top, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-width-right`, 0)} data-svelte-h="svelte-j27ple">Right</label> <input type="number"${add_attribute("id", `card-template-border-width-right`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.width.right, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-width-bottom`, 0)} data-svelte-h="svelte-1qa32my">Bottom</label> <input type="number"${add_attribute("id", `card-template-border-width-bottom`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.width.bottom, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-width-left`, 0)} data-svelte-h="svelte-147m1aa">Left</label> <input type="number"${add_attribute("id", `card-template-border-width-left`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.width.left, 0)}></div></div></fieldset> <fieldset class="flex column container"><legend data-svelte-h="svelte-qpq1rq">Radius</legend> <div class="flex row"><div class="flex column"><div class="flex column"><label${add_attribute("for", `card-template-border-radius-top`, 0)} data-svelte-h="svelte-z5srf7">Top Left</label> <input type="number"${add_attribute("id", `card-template-border-radius-top`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.radius.topLeft, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-radius-left`, 0)} data-svelte-h="svelte-ab289t">Bottom Left</label> <input type="number"${add_attribute("id", `card-template-border-radius-left`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.radius.bottomLeft, 0)}></div></div> <div class="flex column"><div class="flex column"><label${add_attribute("for", `card-template-border-radius-right`, 0)} data-svelte-h="svelte-zpll2r">Top Right</label> <input type="number"${add_attribute("id", `card-template-border-radius-right`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.radius.topRight, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-radius-bottom`, 0)} data-svelte-h="svelte-1eb7ie6">Bottom Right</label> <input type="number"${add_attribute("id", `card-template-border-radius-bottom`, 0)} step="0.01" min="0"${add_attribute("value", $template.border.radius.bottomRight, 0)}></div></div></div></fieldset></div></div>` : ``}`;
});
const ColorControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $template, $$unsubscribe_template;
  $$unsubscribe_template = subscribe(template, (value) => $template = value);
  $$unsubscribe_template();
  return `<div class="flex column"><div class="flex row header" data-svelte-h="svelte-ge6l3p"><h3>Colors</h3></div> <div class="flex column container"><div class="flex row"><div class="flex column"><label for="card-template-background-color" data-svelte-h="svelte-1d0plhu">Background</label> <input type="color" id="card-template-background-color"${add_attribute("value", $template.backgroundColor, 0)}></div> <div class="flex column"><label for="card-template-color" data-svelte-h="svelte-67bdxs">Text</label> <input type="color" id="card-template-color"${add_attribute("value", $template.color, 0)}></div></div></div></div>`;
});
const css$7 = {
...
const TextElementControl = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `   ${template2 ? `<li class="${[
    "flex column container svelte-1u6e3cf",
    template2.minimized ? "minimized" : ""
  ].join(" ").trim()}"${add_attribute("id", `text-element-${id}-control`, 0)} tabindex="0"><div class="flex row header svelte-1u6e3cf"><input type="color"${add_attribute("id", `text-element-${id}-color`, 0)} class="svelte-1u6e3cf"${add_attribute("value", template2.color, 0)}> <input type="text" class="title svelte-1u6e3cf"${add_attribute("value", template2.title, 0)}${add_attribute("this", title, 0)}> <div class="container-controls svelte-1u6e3cf"><button type="button"${add_attribute("aria-label", `${template2.minimized ? "Expand" : "Minimize"} ${template2.title}`, 0)} class="minimize svelte-1u6e3cf"><span class="svelte-1u6e3cf">${template2.minimized ? `+` : ``} ${!template2.minimized ? `—` : ``}</span></button></div> <button type="button"${add_attribute("aria-label", `Remove ${template2.title}`, 0)} class="delete svelte-1u6e3cf">✕</button></div> <div class="${["content svelte-1u6e3cf", template2.minimized ? "minimized" : ""].join(" ").trim()}"><div class="flex column"><div class="flex row"><div class="flex column"><label${add_attribute("for", `text-element-${id}-font-size`, 0)}>Size</label> <input type="number"${add_attribute("id", `text-element-${id}-font-size`, 0)} step="0.01" min="0"${add_attribute("value", template2.fontSize, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-font-weight`, 0)}>Weight</label> <select${add_attribute("id", `text-element-${id}-font-weight`, 0)}><option value="100" data-svelte-h="svelte-5jcfa7">100</option><option value="200" data-svelte-h="svelte-181x5js">200</option><option value="300" data-svelte-h="svelte-l4fqv1">300</option><option selected value="400" data-svelte-h="svelte-qwpw0x">400</option><option value="500" data-svelte-h="svelte-95tr37">500</option><option value="600" data-svelte-h="svelte-1ryyh5o">600</option><option value="700" data-svelte-h="svelte-1401nxt">700</option><option value="800" data-svelte-h="svelte-1vvxlka">800</option><option value="900" data-svelte-h="svelte-saffqf">900</option></select></div></div> <div class="flex row wrap formatting svelte-1u6e3cf"> <label class="flex row svelte-1u6e3cf"><input type="checkbox" class="svelte-1u6e3cf"${add_attribute("checked", textElementState.italic, 1)}><span class="italic svelte-1u6e3cf" data-svelte-h="svelte-cocp0l">italic</span></label> <label class="flex row svelte-1u6e3cf"><input type="checkbox" class="svelte-1u6e3cf"${add_attribute("checked", textElementState.underline, 1)}><span class="underline svelte-1u6e3cf" data-svelte-h="svelte-fwl345">underline</span></label> <label class="flex row svelte-1u6e3cf"><input type="checkbox" class="svelte-1u6e3cf"${add_attribute("checked", textElementState.lineThrough, 1)}><span class="strikethrough svelte-1u6e3cf" data-svelte-h="svelte-l247qj">strikethrough</span></label></div>  <fieldset class="flex column container svelte-1u6e3cf"><legend data-svelte-h="svelte-1qp1cxt">Padding</legend> <div class="flex row wrap"><div class="flex column"><label${add_attribute("for", `text-element-${id}-padding-top`, 0)}>Top</label> <input type="number"${add_attribute("id", `text-element-${id}-padding-top`, 0)} step="0.01" min="0"${add_attribute("value", template2.padding.top, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-padding-right`, 0)}>Right</label> <input type="number"${add_attribute("id", `text-element-${id}-padding-right`, 0)} step="0.01" min="0"${add_attribute("value", template2.padding.right, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-padding-bottom`, 0)}>Bottom</label> <input type="number"${add_attribute("id", `text-element-${id}-padding-bottom`, 0)} step="0.01" min="0"${add_attribute("value", template2.padding.bottom, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-padding-left`, 0)}>Left</label> <input type="number"${add_attribute("id", `text-element-${id}-padding-left`, 0)} step="0.01" min="0"${add_attribute("value", template2.padding.left, 0)}></div></div></fieldset> <fieldset class="flex column container svelte-1u6e3cf"><div class="flex row header align-center svelte-1u6e3cf"><input type="color"${add_attribute("id", `text-element-${id}-border-color`, 0)} class="svelte-1u6e3cf"${add_attribute("value", template2.border.color, 0)}> <legend data-svelte-h="svelte-80fsa2">Border</legend></div> <fieldset class="flex column container svelte-1u6e3cf"><legend data-svelte-h="svelte-uc2uzi">Width</legend> <div class="flex row wrap"><div class="flex column"><label${add_attribute("for", `text-element-${id}-border-width-top`, 0)}>Top</label> <input type="number"${add_attribute("id", `text-element-${id}-border-width-top`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.width.top, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-border-width-right`, 0)}>Right</label> <input type="number"${add_attribute("id", `text-element-${id}-border-width-right`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.width.right, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-border-width-bottom`, 0)}>Bottom</label> <input type="number"${add_attribute("id", `text-element-${id}-border-width-bottom`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.width.bottom, 0)}></div> <div class="flex column"><label${add_attribute("for", `text-element-${id}-border-width-left`, 0)}>Left</label> <input type="number"${add_attribute("id", `text-element-${id}-border-width-left`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.width.left, 0)}></div></div></fieldset> <fieldset class="flex column container svelte-1u6e3cf"><legend data-svelte-h="svelte-qpq1rq">Radius</legend> <div class="flex row"><div class="flex column"><div class="flex column"><label${add_attribute("for", `card-template-border-radius-top`, 0)} data-svelte-h="svelte-z5srf7">Top Left</label> <input type="number"${add_attribute("id", `card-template-border-radius-top`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.radius.topLeft, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-radius-left`, 0)} data-svelte-h="svelte-ab289t">Bottom Left</label> <input type="number"${add_attribute("id", `card-template-border-radius-left`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.radius.bottomLeft, 0)}></div></div> <div class="flex column"><div class="flex column"><label${add_attribute("for", `card-template-border-radius-right`, 0)} data-svelte-h="svelte-zpll2r">Top Right</label> <input type="number"${add_attribute("id", `card-template-border-radius-right`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.radius.topRight, 0)}></div> <div class="flex column"><label${add_attribute("for", `card-template-border-radius-bottom`, 0)} data-svelte-h="svelte-1eb7ie6">Bottom Right</label> <input type="number"${add_attribute("id", `card-template-border-radius-bottom`, 0)} step="0.01" min="0"${add_attribute("value", template2.border.radius.bottomRight, 0)}></div></div></div></fieldset></fieldset></div></div></li>` : ``}`;
});
const css$6 = {
...
const TemplateDrawer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_activeElement();
  return `${$activeSidebarMenu && !$activeElement ? `<div class="container svelte-172mpsw">${$activeSidebarMenu === "card" ? `${validate_component(CardControls, "CardControls").$$render($$result, {}, {}, {})}` : ``} ${$activeSidebarMenu === "color" ? `${validate_component(ColorControls, "ColorControls").$$render($$result, {}, {}, {})}` : ``} ${$activeSidebarMenu === "text" && !$activeElement ? `${validate_component(TextElementControls, "TextElementControls").$$render($$result, {}, {}, {})}` : ``}</div>` : ``} ${$activeElement ? `${validate_component(TextElementControl, "TextElementControl").$$render($$result, { id: $activeElement }, {}, {})}` : ``}`;
});
const css$4 = {
...
const Drawer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_activeSidebarMenu();
  $$unsubscribe_activeElement();
  return `<div class="column drawer svelte-18exqho">${$activeSidebarMenu || $activeElement ? `<div class="controls-container svelte-18exqho"><div class="flex column controls svelte-18exqho"> ${validate_component(TemplateDrawer, "TemplateDrawer").$$render($$result, {}, {}, {})} </div></div>` : ``} <div class="flex row menu svelte-18exqho"><button class="svelte-18exqho" data-svelte-h="svelte-1tfwtwm">card</button> <button class="svelte-18exqho" data-svelte-h="svelte-dd9f4q">color</button> <button class="svelte-18exqho" data-svelte-h="svelte-132gp7m">text</button> <button class="svelte-18exqho" data-svelte-h="svelte-1lbxntu">image</button></div> </div>`;
});
const css$3 = {
...
const TemplateEditor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex template-editor svelte-oevn3t"><div class="card svelte-oevn3t">${validate_component(Card, "Card").$$render($$result, {}, {}, {})}</div> </div>`;
});
...
const EditTemplate = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="flex column editor svelte-1hnp8r8"><div class="main flex svelte-1hnp8r8">${$activeView === "template" ? `${validate_component(TemplateEditor, "TemplateEditor").$$render($$result, {}, {}, {})}` : ``} ${$activeView === "print" ? `${validate_component(PrintLayout, "PrintLayout").$$render($$result, {}, {}, {})}` : ``}</div> ${``} ${`<div class="drawer svelte-1hnp8r8">${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {})}</div>`} </div>`;
});
