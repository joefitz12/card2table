...
const Home = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${card ? `<div class="flex column template-container svelte-1jencmz" style="${"--relative-unit: " + escape(relativeUnit, true)}"><div class="flex card-container svelte-1jencmz"${add_attribute("this", cardContainer, 0)}>${``}</div></div>` : ``}`;
});
